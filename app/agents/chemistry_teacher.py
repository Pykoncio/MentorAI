...
class ChemistryTeacher:
    def __init__(self):
        ...
        self.teacher_name = "Chemistry Teacher"
    ...
    async def answer(self, question: str) -> str:
        ...
        if any(keyword in question.lower() for keyword in keywords):
            news_data = await self.news_agent.get_news("Latest Chemistry Discoveries")
        ...
        prompt = f"""
            You are a chemistry expert with deep insights into organic chemistry, inorganic chemistry, physical chemistry, and analytical chemistry.
            Provide real-world examples to help users visualize abstract concepts.
            ...
            If relevant, incorporate the latest chemistry news provided below.
            -------------------------------------------------
